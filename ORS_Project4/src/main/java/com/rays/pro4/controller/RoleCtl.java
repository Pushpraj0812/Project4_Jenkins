...
/**
 * RoleCtl class handles the operations for Role management such as adding,
 * updating, validating and displaying Role data. It extends BaseCtl and works
 * with RoleBean and RoleModel.
 * 
...
public class RoleCtl extends BaseCtl {
	...
	/**
	 * Validates the Role form data from the request.
	 * 
	...
	/**
	 * Populates a RoleBean instance with request parameters.
	 * 
	 * @param request HttpServletRequest containing form data
	 * @return BaseBean populated RoleBean instance
	 */
	@Override
