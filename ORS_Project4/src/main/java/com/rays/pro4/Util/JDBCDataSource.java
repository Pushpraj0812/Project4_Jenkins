...
public final class JDBCDataSource {
	...
	/**
	 * Rolls back the current database transaction on the given connection.
	 * <p>
	 * This method should be called when a database operation fails and you need to
	 * revert all changes made during the current transaction. If the connection is
	 * null, this method does nothing.
	 *
	 * @param connection the {@link java.sql.Connection} object on which rollback
	 *                   should be performed
	 * @throws ApplicationException if a {@link java.sql.SQLException} occurs during
	 *                              rollback
	 */
