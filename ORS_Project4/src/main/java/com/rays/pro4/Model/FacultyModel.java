...
/**
 * JDBC Implementation of FacultyModel. Handles operations related to Faculty
 * entity such as add, update, delete, search, and retrieval.
 * 
...
public class FacultyModel {
	...
	/**
	 * Gets the next primary key from the st_faculty table.
	 *
	 ...
	 * @throws Exception if any error occurs during add operation
	 */
	 ...
	 *
	 * @param bean FacultyBean object containing faculty ID to delete
...
//			 throw new ApplicationException("Exception in updatingcourse" );
	 ...
	 * @return FacultyBean object or null if not found
	 * @throws ApplicationException if any database error occurs
	 */
	...
	/**
	 * Finds a Faculty by email ID.
	 *
	 * @param Email the email ID of the faculty
	 * @return FacultyBean object or null if not found
	 * @throws ApplicationException if any database error occurs
	 */
	...
	/**
	 * Gets list of all Faculty records.
	 *
	...
	/**
	 * Gets paginated list of Faculty records.
	 *
	...
	/**
	 * Searches Faculty records based on given bean.
	 *
	...
	/**
	 * Searches Faculty records with pagination based on given bean.
	 *
	 * @param bean     FacultyBean containing search criteria
	 * @param pageNo   the page number
	 * @param pageSize the size of the page
