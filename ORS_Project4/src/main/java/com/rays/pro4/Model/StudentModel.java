...
/**
 * JDBC Implementation of Student Model. Provides CRUD operations and
 * search/list functionality for StudentBean.
 * 
...
public class StudentModel {
	...
	/**
	 * Returns the next primary key of Student table.
	 * 
	 ...
	 * @return primary key of the newly added student
	 ...
	 * 
	 * @param bean the StudentBean to delete
	 * @throws ApplicationException if there is an application-level error
	 */
	...
	/**
	 * Finds a student by their email ID.
	 * 
	 ...
	 * 
	 * @param bean the StudentBean containing updated details
	 * @throws ApplicationException     if there is an application-level error
	 * @throws DuplicateRecordException if a student with the same email exists
	 */
	...
	/**
	 * Searches for students matching the given bean criteria.
	 * 
	 * @param bean StudentBean with search criteria
